...
<head>
    ...
    <script>
        ...
        async function controllaLaRisposta() {
            let input = document.getElementById("nomeBandiera");
            let guess = input.value.trim().toLowerCase();
            let corretto = nomePaeseCorretto.trim().toLowerCase();
            ...
            if (guess == corretto) {
                ...
                let bottoneContinua = document.createElement("button");
                ...
                window.location.href = `salvaPunteggio.php?score=${punteggioCorrente}&tipologia=bandiere&nazioneCorretta=${corretto}`;
