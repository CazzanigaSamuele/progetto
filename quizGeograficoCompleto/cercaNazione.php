...
<head>
    ...
    <script>
        async function cercaNazione() { // Funzione per cercare una nazione
            ...
            const apiUrl = "https://restcountries.com/v3.1/name/" + nazione;
            ...
            try {
                ...
                for (const country of data) {
                    ...
                    regionP.textContent = "Regione: "+country.region;
                    ...
                    areaP.textContent = "Area:" +country.area+ "km²"  ;
                ...
                alert('Errore nel cercare la nazione.'); // Gestisce gli errori
            }
        }
    </script>
</head>
<body>
    ...
    <p><a href="paginaPrincipale.php">Torna all'index</a></p> <!-- Link per tornare all'index -->
</body>
</html>